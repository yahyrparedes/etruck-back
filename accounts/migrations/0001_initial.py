    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(help_text='Correo electrónico', max_length=255, unique=True, verbose_name='email address')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='accounts.user', verbose_name='Updated By')),
                ...
                ('updated_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='accounts.user', verbose_name='Updated By')),
